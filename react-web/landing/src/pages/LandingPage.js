  ...
  const tiers = [
    {
      title: 'Free',
      price: '0',
      description: ['3 month trial', '2 basic models', '1 custom portfolio', '15 companies in a portfolio'],
    ...
    },
    {
      ...
      price: '4.99',
      description: ['all basic models', 'cutting edge models', '99 custom portfolios', 'unlimited companies in a portfolio'],
